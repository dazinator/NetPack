## Local development - getting stared
...
- or via `fnm` (see https://github.com/Schniz/fnm) which first requires a little bit of extra setup, but allows you to switch between node versions as needed for different projects.
