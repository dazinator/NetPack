...
namespace NetPack
{
    ...
    public static class PipelineBuilderRollupExtensions
    {
        ...
        public static IPipelineBuilder AddRollupPipe(this IPipelineBuilder builder, Action<PipelineInputBuilder> input, Action<RollupPipeOptionsBuilder> configureOptions = null)
        {
            ...
            RollupPipeOptions options = new RollupPipeOptions();
            RollupPipeOptionsBuilder optionsBuilder = new RollupPipeOptionsBuilder(builder, options);
            ...
            RollupPipe pipe = new RollupPipe(nodeServices, embeddedResourceProvider, logger, options);
