...
namespace NetPack.Utils
{
    ...
    public sealed class ReverseLineReader : IEnumerable<string>
    {
        ...
        public ReverseLineReader(Func<Stream> streamSource, bool leaveOpen = false)
            : this(streamSource, Encoding.UTF8, leaveOpen)
        {
        }
        ...
        public ReverseLineReader(Func<Stream> streamSource, Encoding encoding, bool leaveOpen = false)
            : this(streamSource, encoding, DefaultBufferSize, leaveOpen)
        {
        }

        internal ReverseLineReader(Func<Stream> streamSource, Encoding encoding, int bufferSize, bool leaveOpen = false)
        {
            ...
            else if (encoding is UnicodeEncoding)
            {
                ...
                _characterStartDetector = (pos, data) => (pos % 2) == 0;
            }
