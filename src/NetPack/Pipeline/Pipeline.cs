...
namespace NetPack.Pipeline
{
    ...
    public class Pipeline : IPipeLine
    {
        ...
        public Pipeline(IFileProvider environmentFileProvider, List<PipeConfiguration> pipes, List<IRequirement> requirements, IDirectory sourcesOutputDirectory, string baseRequestPath = null, IDirectory directory = null)
        {
            ...
            //  IsWatching = watch;
            HasFlushed = false;
            ProcessedOutputDirectory = directory ?? new InMemoryDirectory();
            ProcessedOutputFileProvider = new InMemoryFileProvider(ProcessedOutputDirectory);          
        ...
        /// <summary>
        /// Provides access too all processed output files only. These are files that were output as a result of processing some input.
        /// </summary>
        public IFileProvider ProcessedOutputFileProvider { get; set; }

        /// <summary>
        /// Provides access too all files that should be served up to the browser.
        /// </summary>
        ...
        public IDirectory ProcessedOutputDirectory { get; set; }
