...
namespace NetPack
{
    public class JsMinifier : IProcessor
    {
        public Task<string> ProcessInputAsync(FileProcessContext fileProcessContext)
        {
            var jsMin = new JsMin();
        ...
        private class JsMin
        {
            ...
            public Task<string> ProcessAsync(FileProcessContext fileProcessContext)
            {
                ...
                using (_sr = new StringReader(fileProcessContext.FileContents))
